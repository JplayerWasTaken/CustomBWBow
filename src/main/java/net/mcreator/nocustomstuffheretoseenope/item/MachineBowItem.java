...
public class MachineBowItem extends NocustomstuffheretoseenopeModElements.ModElement {
	@ObjectHolder("nocustomstuffheretoseenope:machine_bow")
	public static final Item block = null;
	@ObjectHolder("nocustomstuffheretoseenope:entitybulletmachine_bow")
	public static final EntityType arrow = null;
	public MachineBowItem(NocustomstuffheretoseenopeModElements instance) {
		super(instance, 3);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletmachine_bow").setRegistryName("entitybulletmachine_bow"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3.1f, 0.1, 0);
