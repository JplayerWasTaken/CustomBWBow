...
public class FireBowItem extends NocustomstuffheretoseenopeModElements.ModElement {
	@ObjectHolder("nocustomstuffheretoseenope:fire_bow")
	public static final Item block = null;
	@ObjectHolder("nocustomstuffheretoseenope:entitybulletfire_bow")
	public static final EntityType arrow = null;
	public FireBowItem(NocustomstuffheretoseenopeModElements instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletfire_bow").setRegistryName("entitybulletfire_bow"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 0.5, 1);
			...
			if (this.inGround) {
				{
					...
					FireBowBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
