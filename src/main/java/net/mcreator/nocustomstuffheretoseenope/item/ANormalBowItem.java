...
public class ANormalBowItem extends NocustomstuffheretoseenopeModElements.ModElement {
	@ObjectHolder("nocustomstuffheretoseenope:a_normal_bow")
	public static final Item block = null;
	@ObjectHolder("nocustomstuffheretoseenope:entitybulleta_normal_bow")
	public static final EntityType arrow = null;
	public ANormalBowItem(NocustomstuffheretoseenopeModElements instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulleta_normal_bow").setRegistryName("entitybulleta_normal_bow"));
	}
